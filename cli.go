...
func (cli *CLI) printUsage() {
	...
	fmt.Println("   createwallet - Generates a new key-pai and saves it into the wallet file")
...
func (cli *CLI) Run() {
	...
	startNodeMiner := startNodeCmd.String("miner", "", "Enbale mining node and send reward to ADDRESS")
